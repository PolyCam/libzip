...
typedef struct {
    ...
    libzip_uint64_t file_size;
    libzip_uint32_t file_crc;
    int verbose;
} diff_output_t;
...
void diff_output_data(diff_output_t *output, int side, const libzip_uint8_t *data, libzip_uint64_t data_length, const char *fmt, ...) PRINTF_LIKE(5, 6);
